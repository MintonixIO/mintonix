...
const ICONS = [Activity, BarChart3, Gauge, LineChart, Target, Zap];
...
export default function BlogPage() {
  ...
  const grid = filtered.filter((p) => p.slug !== featured.slug || category !== "all");
  ...
  return (
    <div>
      ...
      {category === "all" || featured.category.toLowerCase() === category ? (
