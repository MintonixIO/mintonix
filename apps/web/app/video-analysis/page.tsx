...
type Shot = { i: number; type: string; side: "FH" | "BH"; color: string; speed?: number };
type Rally = {
  n: number;
  shots: number;
  dur: number;
...
const RALLIES: Rally[] = [
  ...
  },
  {
    ...
    sequence: [
      ...
      { i: 3, type: "Drop", side: "FH", color: "#fbbf24" },
  ...
  },
  {
    ...
    sequence: [
      ...
      { i: 10, type: "Drop", side: "FH", color: "#fbbf24" },
      { i: 11, type: "Net", side: "FH", color: "#2dd4a7" },
      { i: 12, type: "Drop winner", side: "BH", color: "#fbbf24" },
    ],
  },
  {
    n: 4,
  ...
  },
  {
    ...
    sequence: [
      ...
      { i: 4, type: "Drop", side: "FH", color: "#fbbf24" },
      ...
      { i: 12, type: "Drop", side: "FH", color: "#fbbf24" },
  ...
  },
  {
    ...
    sequence: [
      ...
      { i: 4, type: "Lift", side: "FH", color: "#50deff" },
      { i: 5, type: "Drop", side: "BH", color: "#fbbf24" },
  ...
  },
  {
    ...
    sequence: [
      ...
      { i: 13, type: "Drop", side: "FH", color: "#fbbf24" },
...
export default function VideoAnalysisPage() {
  ...
  const [scope, setScope] = useState("rally");
  ...
  const allShots = useMemo(() => RALLIES.flatMap((r) => r.sequence), []);
  ...
  const speedRate =
    speed === "0.5×" ? 0.5 : speed === "1.5×" ? 1.5 : speed === "2×" ? 2 : 1;
          ...
          <div className="flex flex-wrap items-center gap-x-[18px] gap-y-3.5 border-b border-[var(--border-subtle)] px-[18px] py-[15px]">
            <div className="min-w-[180px] flex-1">
              ...
              <div className="mt-0.5 text-[13px] text-[var(--text-secondary)]">
                {scope === "match"
                  ? `${RALLIES.length} rallies · ${allShots.length} shots tracked`
                  : scope === "shot"
            ...
            <div className="mb-[18px] grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {(scope === "match"
                ? [
                    ...
                    { k: "Total shots", v: String(allShots.length), u: "" },
                    {
                      k: "Avg rally",
                      v: (
                        allShots.length / RALLIES.length
                      ).toFixed(1),
                      u: "shots",
                    },
                    {
